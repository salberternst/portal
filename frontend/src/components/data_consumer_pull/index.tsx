import { Datagrid, ArrayField, useShowController, TextField, Show, SimpleShowLayout } from "react-admin";
import {
    ResponsiveContainer,
    AreaChart,
    Area,
...
const SimpleVisualisation = ({record}) =>{
    ...
    {labels.map((label)=><TextField source={"data."+label} key={label}/>)}
    ...
    return(
        <ArrayField source="data">
           < Datagrid rowClick={false} bulkActionButtons={false}>
                    ...
                    {labels.map((label)=><TextField source={label} key={label} />)}
